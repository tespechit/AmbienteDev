...
xclip xsel qt5-default \
libqt5webkit5-dev python-lxml xvfb \
mercurial ffmpeg libsdl1.2-dev \
libsdl2-dev libsmpeg-dev libsdl-image1.2-dev \
libsdl2-image-dev libsdl-mixer1.2-dev libsdl2-mixer-dev \
libsdl-ttf2.0-dev libsdl2-ttf-dev libportmidi-dev \
...
# read -p 'Pressione qualquer tecla para continuar: ' q
    ...
    echo 'O Pycharm-community é a versão mais recente\n: Pycharm-community-'${versaoNova}
    # sleep 3
fi
